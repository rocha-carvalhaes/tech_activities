// Parser do sandbox do plataformer: os 4 params escalares (size/color/jump/speed)
// + caixas repetíveis `box = (col, row)` + objetivo `goal = (col, row)`.
// Mesmo shape de retorno do jogo 1: { values, errors, warnings, ok }, onde
